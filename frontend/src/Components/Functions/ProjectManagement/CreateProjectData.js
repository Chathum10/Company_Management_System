...
export default class CreateProjectData extends Component {
    ...
    generateProjectId = (e) => {
        ...
        this.setState({ projectId: "WL_" + parseInt(this.state.cName) })
    }
    ...
    onSubmit = (e) => {
        ...
        if (formValid(this.state.formErrors)) {
            ...
            axios.post("/projects/save", data).then((res) => {
                ...
                if (res.data.success) {
                    alert("Add Project Data Successfully!");
                    ...
                    <center>
                        ...
                        <MDBCard className='text-black mb-3' style={{ maxWidth: '45rem', backgroundColor: 'rgba(52, 52, 52, 0.4)' }}  >
                            <div className="col-md-8 mt-4 mx-auto">
                                <br />
                                <form>
                                    <h4><span class="badge bg-info text-dark opacity-90 fs-1">Client Information</span></h4><br />
                                    ...
                                    <h4><span class="badge bg-info text-dark opacity-90 fs-1">Project Infomation</span></h4><br />
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form3Example3"><b>Project Description</b></label>
                                        <textarea type="text"
                                            className="form-control"
                                            name="description"
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form3Example3"><b>Assign To</b></label>
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form3Example3"><b>Priority Level</b></label>
                                        <input type="number"
                                            className="form-control"
                                            name="pLevel"
                                            placeholder="(1-5)"
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form3Example3"><b>End Date</b></label>
                                        <input type="date"
                                            className="form-control"
                                            name="eDate"
                                            placeholder=""
                                    ...
                                    <div class="form-outline mb-4">
                                        <label class="form-label" for="form3Example3"><b>Remarks</b></label>
                                        <textarea type="text"
                                            className="form-control"
                                            name="remarks"
                                            placeholder="(Optional)"
