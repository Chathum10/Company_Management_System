...
export default class EmpCount extends Component {
    ...
    generateTotal = (e) => {
        ...
        const {dCategory, dName, dEmail, dTeams, hName, hEmail, hNo, uDate, permanent, contract, interns, total } = this.state;
        this.setState({ total: parseInt(this.state.permanent) + parseInt(this.state.contract) + parseInt(this.state.interns) }); 
      };
    ...
    onSubmit = (e) => {
        ...
        if (formValid(this.state.formErrors)) {
            ...
            const { dCategory, dName, dEmail, dTeams, hName, hEmail, hNo, uDate, permanent, contract, interns, total } =
                this.state;
