...
export default class Performance extends Component {
    ...
    generateOverallRating = (e) => {
        ...
        this.setState({ overallRating: parseInt(this.state.monthRating) + parseInt(this.state.overallRating) });
      };
      ...
      generatePerformance = (e) => {
        ...
        this.setState({ performance: parseInt(this.state.overallRating) / parseInt(this.state.overallmonths) +"/10"}); 
      };
    ...
    onSubmit = (e) => {
        ...
        if (formValid(this.state.formErrors)) {
            ...
            const { name, nic, gender, contactNo, email, empId, joinDate, dueDate, dept, designation, monthRating, overallmonths, overallRating, performance } = this.state;
        ...
        return (
            <div className="back fixed" style={{ zIndex: 8 }}><br />
                <div className="com-md-8 mt-4 mx-auto">
                    <br /> <br />
                    <center><h1><span class="badge bg-info text-dark opacity-90 fs-1">Employee Performance</span></h1></center>
                    <center>
                        <br />
                        ...
                        <div className="col-md-9 mt-4 mx-auto">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <br />
                                        ...
                                        <h4><span class="badge bg-info text-dark opacity-90 fs-1">Performance Calculation</span></h4><br />
